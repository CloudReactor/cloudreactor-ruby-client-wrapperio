...
module CloudReactorAPIClient
  ...
  class Link
    ...
    attr_accessor :link_url_template
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CloudReactorAPIClient::Link` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CloudReactorAPIClient::Link`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'link_url_template')
        self.link_url_template = attributes[:'link_url_template']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          uuid == o.uuid &&
          name == o.name &&
          link_url_template == o.link_url_template &&
          link_url == o.link_url &&
          icon_url == o.icon_url &&
    ...
    def hash
      [uuid, name, link_url_template, link_url, icon_url, description, rank].hash
    end
