...
module CloudReactorAPIClient
  ...
  class AwsEcsServiceLoadBalancerDetails
    ...
    # @param [Object] target_group_arn Value to be assigned
    def target_group_arn=(target_group_arn)
      if target_group_arn.nil?
        fail ArgumentError, 'target_group_arn cannot be nil'
      end

      if target_group_arn.to_s.length > 1000
        fail ArgumentError, 'invalid value for "target_group_arn", the character length must be smaller than or equal to 1000.'
      end
    ...
    def container_name=(container_name)
      if !container_name.nil? && container_name.to_s.length > 1000
        fail ArgumentError, 'invalid value for "container_name", the character length must be smaller than or equal to 1000.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] container_port Value to be assigned
    def container_port=(container_port)
      if container_port.nil?
        fail ArgumentError, 'container_port cannot be nil'
      end

      if container_port > 2147483647
        fail ArgumentError, 'invalid value for "container_port", must be smaller than or equal to 2147483647.'
      end

      if container_port < -2147483648
        fail ArgumentError, 'invalid value for "container_port", must be greater than or equal to -2147483648.'
      end
